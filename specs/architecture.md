...
- Tying the forced home run to a specific out count (e.g. two outs) would let a double or triple play take a tied inning from fewer than two outs straight to three, ending the inning tied without the rule ever firing.
- The bottom of the 30th can legitimately begin with the road team ahead (the road team scored in the top of the 30th, which was played normally). If that half were played normally, a single play could score the tying run *and* record the third out on the bases (a runner thrown out advancing), ending the inning tied with no subsequent plate appearance for the forced-home-run rule to fire on. Forcing a no-advancement out whenever the road team leads removes any chance of the score becoming tied, so the inning must end with the road team ahead.

Together these guarantee the 30th inning can never end tied — a tie is immediately converted into a home-team walk-off, and a road lead is frozen into a road win — so no game can extend beyond it. The bottom of the 30th therefore lasts at most three plate appearances (three forced outs) when the road team leads, or a single plate appearance (the forced home run) when the game is tied. Which team benefits depends on the top of the 30th: a tie entering the bottom half is resolved for the home team, a road lead entering it for the road team. Given how improbable reaching the 30th inning is, this arbitrariness is acceptable. Both forced outcomes take precedence over all other plate-appearance rules, including the pure-pitcher auto-out.
