...
Note: lineup lock deadlines are not stored. They are computed from `sim_scheduled_at` using hardcoded offsets. The exact offset values will be defined in the build plan.
